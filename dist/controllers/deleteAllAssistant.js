...
exports.deleteAllVectorStores = exports.deleteAssistantByIds = exports.listAssistant = void 0;
const openai_1 = __importDefault(require("openai"));
require("dotenv/config");
const openai = new openai_1.default({ apiKey: process.env.OPENAI_API_KEY });
const listAssistant = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteAssistantByIds = (vsIds) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.deleteAssistantByIds = deleteAssistantByIds;
const deleteAllVectorStores = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let fileIds = [];
    try {
        fileIds = yield (0, exports.listAssistant)();
